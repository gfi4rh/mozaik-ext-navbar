    ...
    return(
      <div  className="logger__form">
        <div className="logger__field">
          ...
          <input type="text" name="username" value={username} className="logger__input" onChange={this.handleChange}/>
        </div>
        <div className="logger__field">
          <label htmlFor="password" className="logger__label">Password</label>
          <input type="password" name="password" value={password} className="logger__input" onChange={this.handleChange}/>
        </div>
