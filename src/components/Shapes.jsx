...
class Forward extends React.Component {
  render(){
    const { onClick, width, height, color} = this.props;

    return(<svg onClick={onClick} width={width || ""} height={height || "100%"} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
...
class Login extends React.Component {
  render(){
    ...
    return(<svg onClick={onClick} width={width || ""} height={height || "100%"} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M165 75C165 110.899 135.899 140 100 140C64.1015 140 35 110.899 35 75C35 39.1015 64.1015 10 100 10C135.899 10 165 39.1015 165 75ZM54.9625 75C54.9625 99.8735 75.1265 120.037 100 120.037C124.874 120.037 145.037 99.8735 145.037 75C145.037 50.1265 124.874 29.9625 100 29.9625C75.1265 29.9625 54.9625 50.1265 54.9625 75Z" fill={color || "#C4C4C4"}/>
      </g>
      <defs>
      <clipPath id="clip0">
      <rect width="200" height="200" fill="none"/>
